...
import com.coognet.tksstudio.entities.Project;
...
public class ProjectController extends QueryObject implements Initializable {

    @FXML private TableColumn<Project, Integer> column1;
    @FXML private TableColumn<Project, String> column2;
    ...
    private Project selectedObject;
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        tableView.getSelectionModel().selectedItemProperty().addListener((obs, oldSelection, newSelection) -> {
            if (newSelection != null) {
                ...
                textfield1.setText(selectedObject.getProjectName());


            }
        });

        column1.setCellValueFactory(new PropertyValueFactory<Project, Integer>("projectID"));
        column2.setCellValueFactory(new PropertyValueFactory<Project, String>("projectName"));
    ...
    public void addButtonPushed() {
        ...
        Project temp = new Project(-1, tempAtr1);
        ...
        try {
            ...
            if (resultSet != null) {
                ...
                while (resultSet.next()) {
                    Project temp = new Project(resultSet.getInt("Project_ID"), resultSet.getString("Project_Name"));
