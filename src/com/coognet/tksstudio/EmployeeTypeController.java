...
import com.coognet.tksstudio.entities.EmployeeType;
...
public class EmployeeTypeController extends QueryObject implements Initializable {

    @FXML private TableColumn<EmployeeType, Integer> column1;
    @FXML private TableColumn<EmployeeType, String> column2;
    @FXML private TableView<EmployeeType> tableView;

    @FXML private TextField textfield1;

    private ObservableList<EmployeeType> observableList;
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        tableView.getSelectionModel().selectedItemProperty().addListener((obs, oldSelection, newSelection) -> {
            if (newSelection != null) {
                ...
                textfield1.setText(selectedObject.getEmpTypeName());

            }
        });

        column1.setCellValueFactory(new PropertyValueFactory<EmployeeType, Integer>("empTypeCode"));
        column2.setCellValueFactory(new PropertyValueFactory<EmployeeType, String>("empTypeName"));
    ...
    public void addButtonPushed() {
        ...
        EmployeeType temp = new EmployeeType(-1, tempAtr1);
    ...
    public void loadData() {
        ...
        statement = "SELECT EmpType_Code, EmpType_Name FROM Employee_Type";
        ...
        try {
            ...
            if (resultSet != null) {
                ...
                while (resultSet.next()) {
                    EmployeeType temp = new EmployeeType(resultSet.getInt("EmpType_Code"), resultSet.getString("EmpType_Name"));
