...
import com.coognet.tksstudio.entities.Supplier;
...
public class SupplierController extends QueryObject implements Initializable {

    @FXML private TableColumn<Supplier, Integer> column1;
    @FXML private TableColumn<Supplier, String> column2;
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        tableView.getSelectionModel().selectedItemProperty().addListener((obs, oldSelection, newSelection) -> {
            if (newSelection != null) {
                ...
                textfield1.setText(selectedObject.getSupplierName());

            }
        });

        column1.setCellValueFactory(new PropertyValueFactory<Supplier, Integer>("supplierID"));
        column2.setCellValueFactory(new PropertyValueFactory<Supplier, String>("supplierName"));
    }
    ...
    public void addButtonPushed() {
        ...
        Supplier temp = new Supplier(-1, tempAtr1);
    ...
    public void loadData() {
        ...
        statement = "SELECT Supplier_ID, Supplier_Name FROM Supplier";
        ...
        try {
            ...
            if (resultSet != null) {
                ...
                while (resultSet.next()) {
                    Supplier temp = new Supplier(resultSet.getInt("Supplier_ID"), resultSet.getString("Supplier_Name"));
