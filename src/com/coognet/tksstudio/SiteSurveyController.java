...
import com.coognet.tksstudio.entities.SiteSurvey;
...
public class SiteSurveyController extends QueryObject implements Initializable {

    @FXML private TableColumn<SiteSurvey, Integer> column1;
    @FXML private TableColumn<SiteSurvey, Integer> column2;
    @FXML private TableColumn<SiteSurvey, String> column3;
    @FXML private TableColumn<SiteSurvey, String> column4;
    @FXML private TableView<SiteSurvey> tableView;
    ...
    private ObservableList<SiteSurvey> observableList;
    private SiteSurvey selectedObject;
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        tableView.getSelectionModel().selectedItemProperty().addListener((obs, oldSelection, newSelection) -> {
            if (newSelection != null) {
                ...
                textfield2.setText(selectedObject.getSurveyDate());
                textfield3.setText(selectedObject.getSurveyNotes());

            }
        });

        column1.setCellValueFactory(new PropertyValueFactory<SiteSurvey, Integer>("surveyID"));
        column2.setCellValueFactory(new PropertyValueFactory<SiteSurvey, Integer>("jobPropID"));
        column3.setCellValueFactory(new PropertyValueFactory<SiteSurvey, String>("surveyDate"));
        column4.setCellValueFactory(new PropertyValueFactory<SiteSurvey, String>("surveyNotes"));
    }
    ...
    public void addButtonPushed() {
        ...
        SiteSurvey temp = new SiteSurvey(-1, tempAtr1, tempAtr2, tempAtr3);
    ...
    public void loadData() {
        ...
        statement = "SELECT Survey_ID, JobProp_ID, Survey_Date, Survey_Notes FROM Site_Survey";
        ...
        try {
            ...
            if (resultSet != null) {
                ...
                while (resultSet.next()) {
                    SiteSurvey temp = new SiteSurvey(resultSet.getInt("Survey_ID"), resultSet.getInt("JobProp_ID"), resultSet.getString("Survey_Date"), resultSet.getString("Survey_Notes"));
