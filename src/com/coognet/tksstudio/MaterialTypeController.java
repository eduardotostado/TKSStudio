...
import com.coognet.tksstudio.entities.MaterialType;
...
public class MaterialTypeController extends QueryObject implements Initializable {

    @FXML private TableColumn<MaterialType, Integer> column1;
    @FXML private TableColumn<MaterialType, String> column2;
    ...
    private ObservableList<MaterialType> observableList;
    private MaterialType selectedObject;
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        tableView.getSelectionModel().selectedItemProperty().addListener((obs, oldSelection, newSelection) -> {
            if (newSelection != null) {
                ...
                textfield1.setText(selectedObject.getMatTypeName());

            }
        });

        column1.setCellValueFactory(new PropertyValueFactory<MaterialType, Integer>("matTypeCode"));
        column2.setCellValueFactory(new PropertyValueFactory<MaterialType, String>("matTypeName"));
    ...
    public void addButtonPushed() {
        ...
        MaterialType temp = new MaterialType(-1, tempAtr1);
    ...
    public void loadData() {
        ...
        statement = "SELECT MatType_Code, MatType_Name FROM Material_Type";
        ...
        try {
            ...
            if (resultSet != null) {
                ...
                while (resultSet.next()) {
                    MaterialType temp = new MaterialType(resultSet.getInt("MatType_Code"), resultSet.getString("MatType_Name"));
