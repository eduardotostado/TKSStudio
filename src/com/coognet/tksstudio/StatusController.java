...
import com.coognet.tksstudio.entities.Status;
...
public class StatusController extends QueryObject implements Initializable {

    @FXML private TableColumn<Status, Integer> column1;
    @FXML private TableColumn<Status, String> column2;

    @FXML private TableView<Status> tableView;

    @FXML private TextField textfield1;

    private ObservableList<Status> observableList;
    private Status selectedObject;
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        tableView.getSelectionModel().selectedItemProperty().addListener((obs, oldSelection, newSelection) -> {
            if (newSelection != null) {
                ...
                textfield1.setText(selectedObject.getStatusName());
            }
        });

        column1.setCellValueFactory(new PropertyValueFactory<Status, Integer>("statusID"));
        column2.setCellValueFactory(new PropertyValueFactory<Status, String >("statusName"));
    }
    ...
    public void addButtonPushed() {
        ...
        Status temp = new Status(-1, tempAtr1);
    ...
    public void loadData() {
        ...
        statement = "SELECT Status_ID, Status_Name FROM Status";
        ...
        try {
            ...
            if (resultSet != null) {
                ...
                while (resultSet.next()) {
                    Status temp = new Status(resultSet.getInt("Status_ID"), resultSet.getString("Status_Name"));
