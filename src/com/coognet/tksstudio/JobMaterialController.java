...
import com.coognet.tksstudio.entities.JobMaterial;
...
public class JobMaterialController extends QueryObject implements Initializable {

    @FXML private TableColumn<JobMaterial, Integer> column1;
    @FXML private TableColumn<JobMaterial, Integer> column2;

    @FXML private TableView<JobMaterial> tableView;

    @FXML private TextField textfield1;
    @FXML private TextField textfield2;


    private ObservableList<JobMaterial> observableList;
    private JobMaterial selectedObject;
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        column1.setCellValueFactory(new PropertyValueFactory<JobMaterial, Integer>("jobID"));
        column2.setCellValueFactory(new PropertyValueFactory<JobMaterial, Integer>("materialID"));
    ...
    public void addButtonPushed() {
        ...
        JobMaterial temp = new JobMaterial(tempAtr1, tempAtr2);
    ...
    public void loadData() {
        ...
        statement = "SELECT Job_ID, Material_ID FROM Job_Material";
        ...
        try {
            ...
            if (resultSet != null) {
                ...
                while (resultSet.next()) {
                    JobMaterial temp = new JobMaterial(resultSet.getInt("Job_ID"), resultSet.getInt("Material_ID"));
