...
import com.coognet.tksstudio.entities.Problem;
...
public class ProblemController extends QueryObject implements Initializable {

    @FXML private TableColumn<Problem, Integer> column1;
    @FXML private TableColumn<Problem, String> column2;

    @FXML private TableView<Problem> tableView;

    @FXML private TextArea textfield1;


    private ObservableList<Problem> observableList;
    private Problem selectedObject;
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        tableView.getSelectionModel().selectedItemProperty().addListener((obs, oldSelection, newSelection) -> {
            if (newSelection != null) {
                ...
                textfield1.setText(selectedObject.getPrblmDesc());
            }
        });

        column1.setCellValueFactory(new PropertyValueFactory<Problem, Integer>("prblmID"));
        column2.setCellValueFactory(new PropertyValueFactory<Problem, String>("prblmDesc"));
    }
    ...
    public void addButtonPushed() {
        ...
        Problem temp = new Problem(-1, tempAtr1);
    ...
    public void loadData() {
        ...
        statement = "SELECT Prblm_ID, Prblm_Desc FROM Problem";
        ...
        try {
            ...
            if (resultSet != null) {
                ...
                while (resultSet.next()) {
                    Problem temp = new Problem(resultSet.getInt("Prblm_ID"), resultSet.getString("Prblm_Desc"));
