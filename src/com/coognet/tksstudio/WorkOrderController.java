...
import com.coognet.tksstudio.entities.WorkOrder;
...
public class WorkOrderController extends QueryObject implements Initializable {

    @FXML private TableColumn<WorkOrder, Integer> column1;
    @FXML private TableColumn<WorkOrder, Integer> column2;

    @FXML private TableView<WorkOrder> tableView;

    @FXML private TextField textfield1;
    @FXML private TextField textfield2;

    private ObservableList<WorkOrder> observableList;
    private WorkOrder selectedObject;
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        tableView.getSelectionModel().selectedItemProperty().addListener((obs, oldSelection, newSelection) -> {
            if (newSelection != null) {
                ...
                textfield1.setText(Integer.toString(selectedObject.getContID()));
                textfield2.setText(Integer.toString(selectedObject.getProjectID()));
            }
        });

        column1.setCellValueFactory(new PropertyValueFactory<WorkOrder, Integer>("contID"));
        column2.setCellValueFactory(new PropertyValueFactory<WorkOrder, Integer>("projectID"));
    ...
    public void addButtonPushed() {
        ...
        WorkOrder temp = new WorkOrder(tempAtr1, tempAtr2);
    ...
    public void loadData() {
        ...
        statement = "SELECT Cont_ID, Project_ID FROM Work_Order";
        ...
        try {
            ...
            if (resultSet != null) {
                ...
                while (resultSet.next()) {
                    WorkOrder temp = new WorkOrder(resultSet.getInt("Cont_ID"), resultSet.getInt("Project_ID"));
