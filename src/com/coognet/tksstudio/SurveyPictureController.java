...
import com.coognet.tksstudio.entities.SurveyPicture;
...
public class SurveyPictureController extends QueryObject implements Initializable {

    @FXML private TableColumn<SurveyPicture, Integer> column1;
    @FXML private TableColumn<SurveyPicture, Integer> column2;
    @FXML private TableColumn<SurveyPicture, String> column3;
    @FXML private TableColumn<SurveyPicture, String> column4;
    @FXML private TableView<SurveyPicture> tableView;

    @FXML private TextField textfield1;
    @FXML private TextField textfield2;
    @FXML private TextField textfield3;

    private ObservableList<SurveyPicture> observableList;
    private SurveyPicture selectedObject;
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        tableView.getSelectionModel().selectedItemProperty().addListener((obs, oldSelection, newSelection) -> {
            if (newSelection != null) {
                ...
                textfield1.setText(Integer.toString(selectedObject.getSurveyID()));
                textfield2.setText(selectedObject.getPictureDesc());
                textfield3.setText(selectedObject.getPictureURL());
            }
        });

        column1.setCellValueFactory(new PropertyValueFactory<SurveyPicture, Integer>("pictureID"));
        column2.setCellValueFactory(new PropertyValueFactory<SurveyPicture, Integer>("surveyID"));
        column3.setCellValueFactory(new PropertyValueFactory<SurveyPicture, String>("pictureDesc"));
        column4.setCellValueFactory(new PropertyValueFactory<SurveyPicture, String>("pictureURL"));
    }
    ...
    public void addButtonPushed() {
        ...
        SurveyPicture temp = new SurveyPicture(-1, tempAtr1, tempAtr2, tempAtr3);
    ...
    public void loadData() {
        ...
        statement = "SELECT Picture_ID, Survey_ID, Picture_Desc, Picture_URL FROM Survey_Picture";
        ...
        try {
            ...
            if (resultSet != null) {
                ...
                while (resultSet.next()) {
                    SurveyPicture temp = new SurveyPicture(resultSet.getInt("Picture_ID"), resultSet.getInt("Survey_ID"), resultSet.getString("Picture_Desc"), resultSet.getString("Picture_URL"));
