...
import com.coognet.tksstudio.entities.Fleet;
...
public class FleetController extends QueryObject implements Initializable {

    @FXML private TableColumn<Fleet, Integer> column1;
    @FXML private TableColumn<Fleet, Integer> column2;
    @FXML private TableColumn<Fleet, Integer> column3;

    @FXML private TableView<Fleet> tableView;

    @FXML private TextField textfield1;
    @FXML private TextField textfield2;


    private ObservableList<Fleet> observableList;
    private Fleet selectedObject;
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        tableView.getSelectionModel().selectedItemProperty().addListener((obs, oldSelection, newSelection) -> {
            if (newSelection != null) {
                ...
                textfield1.setText(Integer.toString(selectedObject.getAccountsPayableID()));
                textfield2.setText(Integer.toString(selectedObject.getFleetVehicleCnt()));

            }
        });

        column1.setCellValueFactory(new PropertyValueFactory<Fleet, Integer>("fleetID"));
        column2.setCellValueFactory(new PropertyValueFactory<Fleet, Integer>("accountsPayableID"));
        column3.setCellValueFactory(new PropertyValueFactory<Fleet, Integer>("fleetVehicleCnt"));
    ...
    public void addButtonPushed() {
        ...
        Fleet temp = new Fleet(-1, tempAtr1, tempAtr2);
    ...
    public void loadData() {
        ...
        statement = "SELECT Fleet_ID, AccountsPayable_ID, Fleet_VehicleCnt FROM Fleet";
        ...
        try {
            ...
            if (resultSet != null) {
                ...
                while (resultSet.next()) {
                    Fleet temp = new Fleet(resultSet.getInt("Fleet_ID"), resultSet.getInt("AccountsPayable_ID"), resultSet.getInt("Fleet_VehicleCnt"));
