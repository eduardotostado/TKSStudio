...
import com.coognet.tksstudio.entities.ReviewStatus;
...
public class ReviewStatusController extends QueryObject implements Initializable {

    @FXML private TableColumn<ReviewStatus, Integer> column1;
    @FXML private TableColumn<ReviewStatus, String> column2;

    @FXML private TableView<ReviewStatus> tableView;

    @FXML private TextField textfield1;


    private ObservableList<ReviewStatus> observableList;
    private ReviewStatus selectedObject;
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        tableView.getSelectionModel().selectedItemProperty().addListener((obs, oldSelection, newSelection) -> {
            if (newSelection != null) {
                ...
                textfield1.setText(selectedObject.getRvwStatus_Name());
            }
        });

        column1.setCellValueFactory(new PropertyValueFactory<ReviewStatus, Integer>("rvwStatusID"));
        column2.setCellValueFactory(new PropertyValueFactory<ReviewStatus, String>("rvwStatus_Name"));
    ...
    public void addButtonPushed() {
        ...
        ReviewStatus temp = new ReviewStatus(-1, tempAtr1);
    ...
    public void loadData() {
        ...
        statement = "SELECT RvwStatus_ID, RvwStatus_Name FROM Review_Status";
        ...
        try {
            ...
            if (resultSet != null) {
                ...
                while (resultSet.next()) {
                    ReviewStatus temp = new ReviewStatus(resultSet.getInt("RvwStatus_ID"), resultSet.getString("RvwStatus_Name"));
