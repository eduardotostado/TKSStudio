...
import com.coognet.tksstudio.entities.EmployeeOrderLine;
...
public class EmployeeOrderLineController extends QueryObject implements Initializable {

    @FXML private TableColumn<EmployeeOrderLine, Integer> column1;
    @FXML private TableColumn<EmployeeOrderLine, Integer> column2;
    @FXML private TableColumn<EmployeeOrderLine, Integer> column3;
    @FXML private TableColumn<EmployeeOrderLine, Integer> column4;
    @FXML private TableView<EmployeeOrderLine> tableView;
    ...
    private ObservableList<EmployeeOrderLine> observableList;
    private EmployeeOrderLine selectedObject;
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        tableView.getSelectionModel().selectedItemProperty().addListener((obs, oldSelection, newSelection) -> {
            if (newSelection != null) {
                ...
                textfield1.setText(Integer.toString(selectedObject.getEPOID()));
                textfield2.setText(Integer.toString(selectedObject.getMaterialSourceID()));
                textfield3.setText(Integer.toString(selectedObject.getEOLQuantity()));

            }
        });

        column1.setCellValueFactory(new PropertyValueFactory<EmployeeOrderLine, Integer>("eOLID"));
        column2.setCellValueFactory(new PropertyValueFactory<EmployeeOrderLine, Integer>("ePOID"));
        column3.setCellValueFactory(new PropertyValueFactory<EmployeeOrderLine, Integer>("materialSourceID"));
        column4.setCellValueFactory(new PropertyValueFactory<EmployeeOrderLine, Integer>("eOLQuantity"));
    ...
    public void addButtonPushed() {
        ...
        int tempAtr3 = Integer.parseInt(textfield3.getText());

        EmployeeOrderLine temp = new EmployeeOrderLine(-1, tempAtr1, tempAtr2, tempAtr3);
    ...
    public void loadData() {
        ...
        statement = "SELECT EOL_ID, EPO_ID, MaterialSource_ID, EOL_Quantity FROM Employee_Order_Line";
        ...
        try {
            ...
            if (resultSet != null) {
                ...
                while (resultSet.next()) {
                    EmployeeOrderLine temp = new EmployeeOrderLine(resultSet.getInt("EOL_ID"), resultSet.getInt("EPO_ID"), resultSet.getInt("MaterialSource_ID"), resultSet.getInt("EOL_Quantity"));
