...
import com.coognet.tksstudio.entities.TaskProblem;
...
public class TaskProblemController extends QueryObject implements Initializable {

    @FXML private TableColumn<TaskProblem, Integer> column1;
    @FXML private TableColumn<TaskProblem, Integer> column2;
    @FXML private TableView<TaskProblem> tableView;

    @FXML private TextField textfield1;
    @FXML private TextField textfield2;


    private ObservableList<TaskProblem> observableList;
    private TaskProblem selectedObject;
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        tableView.getSelectionModel().selectedItemProperty().addListener((obs, oldSelection, newSelection) -> {
            if (newSelection != null) {
                ...
                textfield1.setText(Integer.toString(selectedObject.getTaskID()));
                textfield2.setText(Integer.toString(selectedObject.getPrblmID()));

            }
        });

        column1.setCellValueFactory(new PropertyValueFactory<TaskProblem, Integer>("taskID"));
        column2.setCellValueFactory(new PropertyValueFactory<TaskProblem, Integer>("prblmID"));
    }
    ...
    public void addButtonPushed() {
        ...
        TaskProblem temp = new TaskProblem(tempAtr1, tempAtr2);
    ...
    public void loadData() {
        ...
        statement = "SELECT Task_ID, Prblm_ID FROM Task_Problem";
        ...
        try {
            ...
            if (resultSet != null) {
                ...
                while (resultSet.next()) {
                    TaskProblem temp = new TaskProblem(resultSet.getInt("Task_ID"), resultSet.getInt("Prblm_ID"));
